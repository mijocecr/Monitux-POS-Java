...
/*
    public byte[] GeneratePdfToBytes() {
        try {
            ...
            empresaCell.addElement(new Paragraph("Nombre Empresa", new Font(Font.HELVETICA, 16, Font.BOLD)));
            empresaCell.addElement(new Paragraph("Direccion Empresa", normalFont));
            ...
            document.add(new Paragraph("Tipo de venta: " + TipoVenta, normalFont));
            document.add(new Paragraph("Método de pago: " + MetodoPago, normalFont));
            ...
            itemTable.addCell(new PdfPCell(new Phrase("Código", boldFont)));
            itemTable.addCell(new PdfPCell(new Phrase("Descripción", boldFont)));
            itemTable.addCell(new PdfPCell(new Phrase("Cantidad", boldFont)));
            itemTable.addCell(new PdfPCell(new Phrase("Precio", boldFont)));
            itemTable.addCell(new PdfPCell(new Phrase("Total", boldFont)));
            ...
            for (Item_Factura item : Items) {
                ...
                itemTable.addCell(new PdfPCell(new Phrase(String.valueOf(item.getCantidad()), normalFont)));
                itemTable.addCell(new PdfPCell(new Phrase(df.format(item.getPrecio()), normalFont)));
                itemTable.addCell(new PdfPCell(new Phrase(df.format(item.getTotal()), normalFont)));
            ...
            totals.add(new Phrase("Subtotal: " + df.format(subtotal) + "\n", normalFont));
            totals.add(new Phrase("ISV: " + df.format(ISV) + "\n", normalFont));
            totals.add(new Phrase("Otros cargos: " + df.format(OtrosCargos) + "\n", normalFont));
            totals.add(new Phrase("Descuento: -" + df.format(Descuento) + "\n", normalFont));
            totals.add(new Phrase("Total: " + df.format(totalFinal) + "\n", boldFont));
            document.add(totals);
