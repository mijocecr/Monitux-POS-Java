...
public Runnable onAceptar; // El callback
    ...
    public void cargarDatosCotizacion(JTable tabla) {
    // Limpiar la tabla
    ...
    try {
        List<Cotizacion> cotizaciones = em.createQuery(
            "SELECT c FROM Cotizacion c WHERE c.Secuencial_Empresa = :empresa", Cotizacion.class)
        ...
        JOptionPane.showMessageDialog(null,
            "Error al cargar cotizaciones: " + e.getMessage(),
            "Error",
