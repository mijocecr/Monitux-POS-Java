...
import static com.monituxpos.Ventanas.V_Menu_Principal.Secuencial_Empresa;
...
MonituxDBContext.init(
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txt_Direccion, txt_Email, txt_Nombre, txt_Telefono});
        ...
        jLabel11.setToolTipText("Crea un usuario para empresa seleccionada.");
        ...
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addComponent(labelImagen, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tableEmpresasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableEmpresasMouseClicked
       ...
       try {
        ...
        if (secuencialObj != null) {
            ...
            jLabel11.setVisible(!Util.existenUsuariosPorEmpresa(Secuencial));
            this.Secuencial_Empresa=Secuencial;
        }
...
jLabel11.setForeground(Color.white);
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        ...
        V_Usuario usr= new V_Usuario(this.Secuencial_Empresa);
        usr.setVisible(true);
